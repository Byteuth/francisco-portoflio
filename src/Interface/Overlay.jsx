				...
				<section className="section section-3">
					<div className="card-wrapper">
						<div className="card">
							<h2>RecipeBox</h2>
							<p>
								RecipeBox is a mobile app for easily adding and storing recipes
								from any source, offering a centralized hub for searching and
								navigating them. Developed in two weeks by a team of four, the
								app evolved from concept to a functional MVP with extra features
								like Cloud Vision for Optical Character Recognition (OCR).
							</p>
							<p>
								<img
									src="recipebox.png"
						...
						<div className="card">
							<h2>Mini Marble</h2>
							<p>
								Small Marble Platform is a mini platformer where players guide a
								marble through obstacles to reach the finish line. This project
								served as a creative learning platform focused on 3D rendering
								and physics. It enhanced my understanding of user interaction in
								3D environments and game mechanics like collision detection and
								object movement.
							</p>
							<p>
								<img
